...
func (p *FederationProcessor) FediNodeInfoRelGet(ctx context.Context) (*apimodel.WellKnownResponse, gtserror.WithCode) {
...
func (p *FederationProcessor) FediNodeInfoGet(ctx context.Context) (*apimodel.Nodeinfo, gtserror.WithCode) {
	host := config.GetHost()
...
func (p *FederationProcessor) FediWebfingerGet(ctx context.Context, requestedUsername string) (*apimodel.WellKnownResponse, gtserror.WithCode) {
